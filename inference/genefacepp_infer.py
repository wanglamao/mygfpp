...
from data_gen.eg3d.convert_to_eg3d_convention import (
    get_eg3d_convention_camera_pose_intrinsic,
)
from data_gen.utils.mp_feature_extractors.face_landmarker import (
...
# Dataset Related
from tasks.radnerfs.dataset_utils import (
    RADNeRFDataset,
    get_boundary_mask,
...
from modules.radnerfs.utils import (
    get_audio_features,
    get_rays,
    get_bg_coords,
    convert_poses,
...
class GeneFace2Infer:
    ...
    def forward_secc2video(self, batch, inp=None):
        ...
        cmd = f"ffmpeg -i {tmp_out_name} -i {self.wav16k_name} -y -shortest -c:v libx264 -y -shortest {inp['out_name']}"
