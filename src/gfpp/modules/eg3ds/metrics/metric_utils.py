...
import numpy as np
import torch
import gfpp.modules.eg3ds.dnnlib as dnnlib

from gfpp.tasks.eg3ds.dataset_utils.kv_eg3d_ffhq_dataset import KV_FFHQ_EG3D_Dataset
...
def compute_feature_stats_for_dataset(
    ...
    **stats_kwargs,
    ...
    if opts.cache:
        ...
        cache_tag = (
            f"{ds_name}-{get_feature_detector_name(detector_url)}-{md5.hexdigest()}"
        )
